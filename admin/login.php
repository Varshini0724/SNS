  ...
  $(document).ready(function(){
    ...
    function validatePassword() {
      ...
      if (password.length < 6) {
        $('#password-error').text('Password length should be more than 6 characters');
        return false;
      } else {
        $('#password-error').text(''); // Clear error message if password is valid
        return true;
      }
    }
    ...
    // Show error message when password field is clicked
